...
1. **Sistemas Operativos basados en Microkernel:**
...
:::caution[Pregunta]
[¿Qué tipo es Windows 11?](http://somebooks.es/wp-content/uploads/2022/SOM/estructura%20nucleo%20hibrido.png) 
:::
...
| Windows Vista, 7, 8, 10, 11, Windows Server, UNIX, Linux, macOS,  Android, iOS, Chrome OS | Multiusuario   | Multitarea       | Multiproceso       | Tiempo compartido    |
