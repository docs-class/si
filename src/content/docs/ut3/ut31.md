...
:::tip[PDF UT3]
[Descarga UT3 en PDF](https://docs-class.github.io/si/_pdf/SI-Balmis-UT3.pdf)
:::
...
:::caution[Búsqueda avanzada]
Haz una tabla con los diferentes tipos de sistemas de archivos (FAT32, NTFS, ext4, APFS, etc.) indicando sus características principales, ventajas y desventajas, sistemas operativos que lo soportan.

APFS, HFS+, FAT32, exFAT, NTFS, ext4, Btrfs, XFS
:::